...
pub const z_size_t = usize;
pub const Byte = u8;
pub const uInt = c_uint;
pub const uLong = c_ulong;
pub const Bytef = Byte;
pub const charf = u8;
pub const intf = c_int;
pub const uIntf = uInt;
pub const uLongf = uLong;
pub const voidpc = ?*const anyopaque;
pub const voidpf = ?*anyopaque;
pub const voidp = ?*anyopaque;
pub const z_crc_t = c_ulong;
...
pub const struct_z_stream_s = extern struct {
    next_in: [*c]Bytef = @import("std").mem.zeroes([*c]Bytef),
    avail_in: uInt = @import("std").mem.zeroes(uInt),
    total_in: uLong = @import("std").mem.zeroes(uLong),
    next_out: [*c]Bytef = @import("std").mem.zeroes([*c]Bytef),
    avail_out: uInt = @import("std").mem.zeroes(uInt),
    total_out: uLong = @import("std").mem.zeroes(uLong),
    msg: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    state: ?*struct_internal_state = @import("std").mem.zeroes(?*struct_internal_state),
    zalloc: alloc_func = @import("std").mem.zeroes(alloc_func),
    zfree: free_func = @import("std").mem.zeroes(free_func),
    @"opaque": voidpf = @import("std").mem.zeroes(voidpf),
    data_type: c_int = @import("std").mem.zeroes(c_int),
    adler: uLong = @import("std").mem.zeroes(uLong),
    reserved: uLong = @import("std").mem.zeroes(uLong),
};
pub const z_stream = struct_z_stream_s;
pub const z_streamp = [*c]z_stream;
pub const struct_gz_header_s = extern struct {
    text: c_int = @import("std").mem.zeroes(c_int),
    time: uLong = @import("std").mem.zeroes(uLong),
    xflags: c_int = @import("std").mem.zeroes(c_int),
    os: c_int = @import("std").mem.zeroes(c_int),
    extra: [*c]Bytef = @import("std").mem.zeroes([*c]Bytef),
    extra_len: uInt = @import("std").mem.zeroes(uInt),
    extra_max: uInt = @import("std").mem.zeroes(uInt),
    name: [*c]Bytef = @import("std").mem.zeroes([*c]Bytef),
    name_max: uInt = @import("std").mem.zeroes(uInt),
    comment: [*c]Bytef = @import("std").mem.zeroes([*c]Bytef),
    comm_max: uInt = @import("std").mem.zeroes(uInt),
    hcrc: c_int = @import("std").mem.zeroes(c_int),
...
pub extern fn deflate(strm: z_streamp, flush: c_int) c_int;
pub extern fn deflateEnd(strm: z_streamp) c_int;
pub extern fn inflate(strm: z_streamp, flush: c_int) c_int;
pub extern fn inflateEnd(strm: z_streamp) c_int;
pub extern fn deflateSetDictionary(strm: z_streamp, dictionary: [*c]const Bytef, dictLength: uInt) c_int;
pub extern fn deflateGetDictionary(strm: z_streamp, dictionary: [*c]Bytef, dictLength: [*c]uInt) c_int;
pub extern fn deflateCopy(dest: z_streamp, source: z_streamp) c_int;
pub extern fn deflateReset(strm: z_streamp) c_int;
pub extern fn deflateParams(strm: z_streamp, level: c_int, strategy: c_int) c_int;
pub extern fn deflateTune(strm: z_streamp, good_length: c_int, max_lazy: c_int, nice_length: c_int, max_chain: c_int) c_int;
pub extern fn deflateBound(strm: z_streamp, sourceLen: uLong) uLong;
pub extern fn deflatePending(strm: z_streamp, pending: [*c]c_uint, bits: [*c]c_int) c_int;
pub extern fn deflatePrime(strm: z_streamp, bits: c_int, value: c_int) c_int;
pub extern fn deflateSetHeader(strm: z_streamp, head: gz_headerp) c_int;
pub extern fn inflateSetDictionary(strm: z_streamp, dictionary: [*c]const Bytef, dictLength: uInt) c_int;
pub extern fn inflateGetDictionary(strm: z_streamp, dictionary: [*c]Bytef, dictLength: [*c]uInt) c_int;
pub extern fn inflateSync(strm: z_streamp) c_int;
pub extern fn inflateCopy(dest: z_streamp, source: z_streamp) c_int;
pub extern fn inflateReset(strm: z_streamp) c_int;
pub extern fn inflateReset2(strm: z_streamp, windowBits: c_int) c_int;
pub extern fn inflatePrime(strm: z_streamp, bits: c_int, value: c_int) c_int;
pub extern fn inflateMark(strm: z_streamp) c_long;
pub extern fn inflateGetHeader(strm: z_streamp, head: gz_headerp) c_int;
...
pub extern fn inflateBack(strm: z_streamp, in: in_func, in_desc: ?*anyopaque, out: out_func, out_desc: ?*anyopaque) c_int;
pub extern fn inflateBackEnd(strm: z_streamp) c_int;
...
pub extern fn uncompress2(dest: [*c]Bytef, destLen: [*c]uLongf, source: [*c]const Bytef, sourceLen: [*c]uLong) c_int;
pub const struct_gzFile_s = extern struct {
    have: c_uint = @import("std").mem.zeroes(c_uint),
    next: [*c]u8 = @import("std").mem.zeroes([*c]u8),
...
pub extern fn gzbuffer(file: gzFile, size: c_uint) c_int;
pub extern fn gzsetparams(file: gzFile, level: c_int, strategy: c_int) c_int;
pub extern fn gzread(file: gzFile, buf: voidp, len: c_uint) c_int;
pub extern fn gzfread(buf: voidp, size: z_size_t, nitems: z_size_t, file: gzFile) z_size_t;
pub extern fn gzwrite(file: gzFile, buf: voidpc, len: c_uint) c_int;
pub extern fn gzfwrite(buf: voidpc, size: z_size_t, nitems: z_size_t, file: gzFile) z_size_t;
pub extern fn gzprintf(file: gzFile, format: [*c]const u8, ...) c_int;
pub extern fn gzputs(file: gzFile, s: [*c]const u8) c_int;
pub extern fn gzgets(file: gzFile, buf: [*c]u8, len: c_int) [*c]u8;
pub extern fn gzputc(file: gzFile, c: c_int) c_int;
pub extern fn gzgetc(file: gzFile) c_int;
pub extern fn gzungetc(c: c_int, file: gzFile) c_int;
pub extern fn gzflush(file: gzFile, flush: c_int) c_int;
pub extern fn gzrewind(file: gzFile) c_int;
pub extern fn gzeof(file: gzFile) c_int;
pub extern fn gzdirect(file: gzFile) c_int;
pub extern fn gzclose(file: gzFile) c_int;
pub extern fn gzclose_r(file: gzFile) c_int;
pub extern fn gzclose_w(file: gzFile) c_int;
...
pub extern fn crc32_z(adler: uLong, buf: [*c]const Bytef, len: z_size_t) uLong;
pub extern fn deflateInit_(strm: z_streamp, level: c_int, version: [*c]const u8, stream_size: c_int) c_int;
pub extern fn inflateInit_(strm: z_streamp, version: [*c]const u8, stream_size: c_int) c_int;
pub extern fn deflateInit2_(strm: z_streamp, level: c_int, method: c_int, windowBits: c_int, memLevel: c_int, strategy: c_int, version: [*c]const u8, stream_size: c_int) c_int;
pub extern fn inflateInit2_(strm: z_streamp, windowBits: c_int, version: [*c]const u8, stream_size: c_int) c_int;
pub extern fn inflateBackInit_(strm: z_streamp, windowBits: c_int, window: [*c]u8, version: [*c]const u8, stream_size: c_int) c_int;
pub extern fn gzgetc_(file: gzFile) c_int;
...
pub extern fn inflateSyncPoint(z_streamp) c_int;
pub extern fn get_crc_table() [*c]const z_crc_t;
pub extern fn inflateUndermine(z_streamp, c_int) c_int;
pub extern fn inflateValidate(z_streamp, c_int) c_int;
pub extern fn inflateCodesUsed(z_streamp) c_ulong;
pub extern fn inflateResetKeep(z_streamp) c_int;
pub extern fn deflateResetKeep(z_streamp) c_int;
pub extern fn gzvprintf(file: gzFile, format: [*c]const u8, va: va_list) c_int;
...
pub const __weak = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // (no file):407:9
pub const offsetof = @compileError("unable to translate macro: undefined identifier `__builtin_offsetof`"); // /Users/alexlee/Library/Application Support/Code/User/globalStorage/ziglang.vscode-zig/zig_install/lib/include/stddef.h:116:9
pub const ZEXTERN = @compileError("unable to translate C expr: unexpected token 'extern'"); // /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX13.3.sdk/usr/include/zconf.h:377:11
...
pub const va_start = @compileError("unable to translate macro: undefined identifier `__builtin_va_start`"); // /Users/alexlee/Library/Application Support/Code/User/globalStorage/ziglang.vscode-zig/zig_install/lib/include/stdarg.h:33:9
pub const va_end = @compileError("unable to translate macro: undefined identifier `__builtin_va_end`"); // /Users/alexlee/Library/Application Support/Code/User/globalStorage/ziglang.vscode-zig/zig_install/lib/include/stdarg.h:35:9
pub const va_arg = @compileError("unable to translate macro: undefined identifier `__builtin_va_arg`"); // /Users/alexlee/Library/Application Support/Code/User/globalStorage/ziglang.vscode-zig/zig_install/lib/include/stdarg.h:36:9
pub const __va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // /Users/alexlee/Library/Application Support/Code/User/globalStorage/ziglang.vscode-zig/zig_install/lib/include/stdarg.h:41:9
pub const va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // /Users/alexlee/Library/Application Support/Code/User/globalStorage/ziglang.vscode-zig/zig_install/lib/include/stdarg.h:46:9
...
pub const __ENVIRONMENT_OS_VERSION_MIN_REQUIRED__ = @import("std").zig.c_translation.promoteIntLiteral(c_int, 130401, .decimal);
...
pub const STDC99 = "";
pub const z_const = "";
pub const z_longlong = c_longlong;
...
pub const ZLIB_VERSION = "1.2.11";
pub const ZLIB_VERNUM = @as(c_int, 0x12b0);
pub const ZLIB_VER_MAJOR = @as(c_int, 1);
pub const ZLIB_VER_MINOR = @as(c_int, 2);
pub const ZLIB_VER_REVISION = @as(c_int, 11);
...
pub inline fn deflateInit(strm: anytype, level: anytype) @TypeOf(deflateInit_(strm, level, ZLIB_VERSION, @import("std").zig.c_translation.cast(c_int, @import("std").zig.c_translation.sizeof(z_stream)))) {
    return deflateInit_(strm, level, ZLIB_VERSION, @import("std").zig.c_translation.cast(c_int, @import("std").zig.c_translation.sizeof(z_stream)));
}
pub inline fn inflateInit(strm: anytype) @TypeOf(inflateInit_(strm, ZLIB_VERSION, @import("std").zig.c_translation.cast(c_int, @import("std").zig.c_translation.sizeof(z_stream)))) {
    return inflateInit_(strm, ZLIB_VERSION, @import("std").zig.c_translation.cast(c_int, @import("std").zig.c_translation.sizeof(z_stream)));
}
pub inline fn deflateInit2(strm: anytype, level: anytype, method: anytype, windowBits: anytype, memLevel: anytype, strategy: anytype) @TypeOf(deflateInit2_(strm, level, method, windowBits, memLevel, strategy, ZLIB_VERSION, @import("std").zig.c_translation.cast(c_int, @import("std").zig.c_translation.sizeof(z_stream)))) {
    return deflateInit2_(strm, level, method, windowBits, memLevel, strategy, ZLIB_VERSION, @import("std").zig.c_translation.cast(c_int, @import("std").zig.c_translation.sizeof(z_stream)));
}
pub inline fn inflateInit2(strm: anytype, windowBits: anytype) @TypeOf(inflateInit2_(strm, windowBits, ZLIB_VERSION, @import("std").zig.c_translation.cast(c_int, @import("std").zig.c_translation.sizeof(z_stream)))) {
    return inflateInit2_(strm, windowBits, ZLIB_VERSION, @import("std").zig.c_translation.cast(c_int, @import("std").zig.c_translation.sizeof(z_stream)));
}
pub inline fn inflateBackInit(strm: anytype, windowBits: anytype, window: anytype) @TypeOf(inflateBackInit_(strm, windowBits, window, ZLIB_VERSION, @import("std").zig.c_translation.cast(c_int, @import("std").zig.c_translation.sizeof(z_stream)))) {
    return inflateBackInit_(strm, windowBits, window, ZLIB_VERSION, @import("std").zig.c_translation.cast(c_int, @import("std").zig.c_translation.sizeof(z_stream)));
}
